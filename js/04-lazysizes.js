...
// Нативное решение которое встроено в браузер, оно гарантированно будет работать лучше чем любая библиотека
...
// нативную загрузку, т.е. ленивую загрузку). Для этого нам необходимо использовать featurе detection (или определение
...
// проверка наличия у браузера нативной загрузки (ленивой загрузки). Эта часть называется featurе detection (или определение
